...
| **Regenerate** P3 evidence for final thesis             | Run `python scripts/compare_profiles.py`; commit `experiment_comparison.json`; note commit in appendix; tick Track **A** in [PROJECT_JOURNEY.md](PROJECT_JOURNEY.md)                                                                                                                      |
