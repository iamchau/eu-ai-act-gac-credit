...
**Thesis Results (Chapter 6):** Any **numeric** claim in [`thesis/MANUSCRIPT.md`](thesis/MANUSCRIPT.md) under **Results** must trace to **committed** `metrics/*.json` (or the **`git_commit`** inside `experiment_comparison.json`). The rule is stated in [THESIS_FOUNDATION.md](THESIS_FOUNDATION.md) §8 (“Chapter 6 rule”) and in the manuscript **reader note** under `# 6. Results`. **Do not** add unaudited figures in Results prose during Word export.
...
| **Thesis MANUSCRIPT Results**    | Chapter 6 text + tables bind to **committed** JSON — [THESIS_FOUNDATION.md](THESIS_FOUNDATION.md) §8 “Chapter 6 rule” | **New** percentages, seconds, or thresholds in Results that **do not** appear in committed `metrics/` or cited appendices |
...
| [EXCELLENCE_ROADMAP.md](EXCELLENCE_ROADMAP.md)                                 | **Examiner-grade checklist** — spine, manuscript, evidence freeze, submission (pairs with journey/plan)                                 |
| [PROJECT_JOURNEY.md](PROJECT_JOURNEY.md)                                       | **Tickable checklist** — evidence freeze, thesis chapters, MLOps backlog, submission; pairs with [PROJECT_PLAN.md](../PROJECT_PLAN.md) |
...
| Reader                      | Start                                                                                                                                                                                                                                                                                                          |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Thesis author (writing)** | [DOCUMENTATION_FOUNDATION.md](DOCUMENTATION_FOUNDATION.md) (this charter) → [EXCELLENCE_ROADMAP.md](EXCELLENCE_ROADMAP.md) → [PROJECT_JOURNEY.md](PROJECT_JOURNEY.md) (checklist) → [THESIS_FOUNDATION.md](THESIS_FOUNDATION.md) → [THESIS_WRITING_HUB.md](THESIS_WRITING_HUB.md) → [thesis/MANUSCRIPT.md](thesis/MANUSCRIPT.md) (draft) → snippets & citations |
...
| **Regenerate** P3 evidence for final thesis             | Run `python scripts/compare_profiles.py`; commit `experiment_comparison.json`; note commit in appendix; tick Track **A** in [PROJECT_JOURNEY.md](PROJECT_JOURNEY.md); re-check [THESIS_FOUNDATION.md](THESIS_FOUNDATION.md) §8 + Chapter 6 reader note in [thesis/MANUSCRIPT.md](thesis/MANUSCRIPT.md) |
| Edit **Results** in `thesis/MANUSCRIPT.md`              | Re-verify every number against **committed** JSON; update timestamps / `git_commit` lines in Chapter 6 if JSON changes                                                                                                                                                                    |
| Major **milestone** (thesis submit, MLOps backlog done) | [PROJECT_JOURNEY.md](PROJECT_JOURNEY.md) §F; [PROJECT_PLAN.md](../PROJECT_PLAN.md) Completed / Last updated                                                                                                                                                                               |
| Change **serving API or Docker**                        | [deployment/ML_OPS_SERVING_ANALYSIS.md](deployment/ML_OPS_SERVING_ANALYSIS.md), [deployment/TECHNICAL_EXTENSIONS.md](deployment/TECHNICAL_EXTENSIONS.md), [deployment/RUNBOOK.md](deployment/RUNBOOK.md); README **Serving**; `params.yaml` / feature contract if inference inputs change |
